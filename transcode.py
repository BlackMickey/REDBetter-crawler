...
def get_transcode_dir(flac_dir, output_dir, output_format, resample):
    ...
    if resample:
        ...
        if check and ('24' in check.group(1) or '44' in check.group(1) or '48' in check.group(1) or '88' in check.group(1) or '96' in check.group(1)):
            print(Pass)
            return
            ...
            transcode_dir = transcode_dir.replace('24', '16')
        elif '24' in flac_dir and '44' not in flac_dir and '48' not in flac_dir and '88' not in flac_dir and '96' not in flac_dir:
            transcode_dir = transcode_dir.replace('24', '16')
